                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--danger text-white">
                        <div class="widget-three__content">
                            ...
                            <p class="text--small">@lang('Total Withdrawal Charge')</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--8 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Total Categories')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--10 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="currency-sign">{{$widget['totalLeague']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Leagues')</span>
                    </div>
                    <a href="{{route('admin.league.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--18 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['totalMatch']}}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['totalBet']}}</span>
                    </div>
                    <div class="desciption">
