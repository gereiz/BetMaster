    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card border--primary mt-2">
                <h5 class="card-header">@lang('Deposit Commission')
                    @if($general->deposit_commission == 0)
                    <span class="badge badge--danger float-right font-weight-bold">@lang('Disabled')</span>
                    @else
                    <span class="badge badge--success float-right font-weight-bold">@lang('Enabled')</span>
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->deposit_commission == 0)
                            <a href="{{ route('admin.referral.status.update','deposit_commission') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                            <a href="{{ route('admin.referral.status.update','deposit_commission') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach($levels->where('commission_type','deposit') as $item)
                                    <tr>
                                        ...
                                        <td data-label="Commission">{{ $item->percent }} %</td>
                                    </tr>
                                @endforeach
        ...
        <div class="col-md-4 mb-4">
            <div class="card border--primary mt-2">
                <h5 class="card-header">@lang('Bet Place Commission')
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->bet_commission == 0)
                            <a href="{{ route('admin.referral.status.update','bet_commission') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                            <a href="{{ route('admin.referral.status.update','bet_commission') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card border--primary mt-2">
                <h5 class="card-header">@lang('Bet Win Commission')
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->win_commission == 0)
                            <a href="{{ route('admin.referral.status.update','win_commission') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                            <a href="{{ route('admin.referral.status.update','win_commission') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
                    ...
                    if (levelGenerate !== '' && levelGenerate > 0) {
                        ...
                        for (a; a < parseInt(levelGenerate); a++) {
                            viewHtml += `<div class="input-group mt-4">
                                            ...
                                            <input name="percent[]" class="form-control margin-top-10" type="number" step=".01" required placeholder="@lang("Commission Percentage %")">
